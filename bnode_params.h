...
/*
 * Starting index of a BNode's parent pointer
 */
static const size_t PARENT_PTR_INDEX = ELEMENT_COUNT_INDEX + SIZE_T_SIZE_IN_BYTES;

/*
 * Starting index of left sibling pointer for a LeafBNode
 */
static const size_t LEFT_SIBLING_PTR_INDEX = SIZE_T_SIZE_IN_BYTES + POINTER_SIZE_IN_BYTES;
 ...
 */
static const size_t TREE_FIRST_ELEMENT_INDEX = PARENT_PTR_INDEX + POINTER_SIZE_IN_BYTES;
